    ...
    await db.query(`
      ...
      VALUES
        ...
        (
          'heavy', 'Heavy',
          ARRAY[
            'Small creatures have disadvantage on attack rolls with heavy weapon.',
        ...
        (
          'light', 'Light',
          ARRAY[
            'A light weapon is small and easy to handle, making it ideal for use when fighting with two weapon.'
          ]
        ),
        (
          'loading', 'Loading',
