  ...
  try {
    ...
    await db.query(`
      INSERT INTO weapon_property_assignments (weapon_index, property_index) VALUES
        ...
        ('light-hammer', 'light'),
        ('light-hammer', 'thrown'),
        ('mace', 'special') -- if you don't model "none", remove this line; mace has no properties in the SRD
        ,
        ...
        -- Martial Melee
        ('battleaxe', 'versatile'),
        ('flail', 'special') -- flail has no properties in the SRD; remove if you prefer to omit "none"
        ,
        ('glaive', 'heavy'),
        ('glaive', 'reach'),
        ('glaive', 'two-handed'),
        ...
        ('maul', 'heavy'),
        ('maul', 'two-handed'),
        ('morningstar', 'special') -- morningstar has no properties; remove if you prefer to omit "none"
        ,
        ('pike', 'heavy'),
        ('pike', 'reach'),
        ('pike', 'two-handed'),
        ...
        ('trident', 'thrown'),
        ('trident', 'versatile'),
        ('war-pick', 'special') -- no properties; remove if you prefer to omit "none"
        ,
        ('warhammer', 'versatile'),
        ('whip', 'finesse'),
        ('whip', 'reach'),
