...
import { weaponProficiencies } from './weaponProficiencies.js';
import { toolProficiencies } from './toolProficiencies.js';
import { armorProficiencies } from './armorProficiencies.js';
import { generalProficiencies } from './generalProficiencies.js';

export async function seedProficiencies() {
  try {
    await weaponProficiencies();
    await toolProficiencies();
    await armorProficiencies();
    await generalProficiencies();
    console.log('✅ All proficiencies seeded');
  } catch (err) {
    console.error('❌ Error seeding proficiencies:', err);
  }
}
